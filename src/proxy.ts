...
/**
 * Refreshes the Supabase session cookie and gates the dashboard (Next 16 proxy convention): everything
 * except the public widget API, widget.js, login and admin requires a session.
 */
